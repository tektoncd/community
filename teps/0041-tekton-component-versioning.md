...
- [Alternatives](#alternatives)
  - [Provide an Endpoint from the Controller that can be queried](#1-provide-an-endpoint-from-the-controller-that-can-be-queried)
  - [SSH into the Controller Pod](#2-ssh-into-the-controller-pod)
  - [Creating a CRD](#3-creating-a-crd)
  - [Make a Mutating Webhook](#4-make-a-mutating-webhook)
  - [Adding a label in Namespace](#5-adding-a-label-in-namespace)
