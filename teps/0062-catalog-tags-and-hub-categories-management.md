...
- Add category field as annotation in a task
...
- Add categories in catalog task as annotation. There should be only one category for a task. Multiple categories are not allowed.
