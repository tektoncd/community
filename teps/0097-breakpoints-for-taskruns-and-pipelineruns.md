...
- [TaskRun Proposal](#taskrun-proposal)
    - [Breakpoint before/after a step](#breakpoint-before/after-a-step)
    - [Breakpoint on failure of a step](#breakpoint-on-failure-of-a-step)
...
- [PipelineRun Proposal](#pipelinerun-proposal)
    - [Breakpoint before/after a TaskRun](#breakpoint-before-or-after-a-taskrun)
        - [before TaskRun](#before-taskrun)
        - [after TaskRun](#after-taskrun)
        - [Task Dependence](#task-dependence)
