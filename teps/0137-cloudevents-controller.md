...
- [Design Details](#design-details-1)
  - [Events Controller Structure](#events-controller-structure)
  - [Cache Design](#cache-design)
  - [Events Logic](#events-logic)
  - [CDEvents Design](#cdevents-design)
    - [Data Required From Users](#data-required-from-users)
    - [When Events Are Sent](#when-events-are-sent)
    - [User Interface](#user-interface)
    - [Events Controller Interface](#events-controller-interface)
      - [Resource Status](#resource-status)
      - [Custom Resource](#custom-resource)
    - [Triggering of CDEvents](#triggering-of-cdevents)
